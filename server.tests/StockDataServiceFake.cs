...
{
    public class StockDataServiceFake : IStockDataService
    {
        private readonly List<Stock> mockResult;
        public StockDataServiceFake()
        {
            mockResult = new List<Stock> {
        ...
        {
            return Task.FromResult<List<Stock>>(this.mockResult);
        }
    }
}
